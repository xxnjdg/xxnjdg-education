...
public class ListToTreeUtil {
     ...
     * @return 组装后的集合
     */
    public static <T,E> List<T> getTree(List<T> originalList, String keyName,String parentFieldName,String childrenFieldName,E customParentId,Boolean isSort,String sortName) throws Exception {
     ...
     */
    public static <T,E> void fillTree(List<T> parentList, List<T> originalList, String keyName, String parentFieldName, String childrenFieldName,E customParentId,Boolean isSort,String sortName) throws Exception {
     ...
     * @param childrenFieldName 模型中作为children的字段名称
     */
    public static <T,E> List<T> fillChildren(T parent, List<T> originalList, String keyName, String parentFieldName, String childrenFieldName,E customParentId,Boolean isSort,String sortName) throws Exception {
